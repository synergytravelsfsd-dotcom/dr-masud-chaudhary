...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/60 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary:
          "bg-brand-navy text-white hover:bg-brand-navy-soft dark:bg-brand-navy dark:text-white dark:hover:bg-brand-navy-soft",
        secondary:
          "bg-white text-foreground border border-border hover:border-brand-navy/35 hover:bg-brand-navy/[0.04] dark:bg-transparent",
        ghost: "bg-transparent text-foreground hover:bg-brand-navy/5",
